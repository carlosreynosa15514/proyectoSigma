...
<head>
    ...
    <link rel="stylesheet" href="/css/consulta_cl_factura_tabla.css">
    <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <title>Clase de Factura Descripcion</title>
</head>

<body>
    <header>
        <h1> Busqueda Clase de Factura por Descripcion </h1>
    </header>
    <nav class="menu">
    ...
    <main>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            <div class="form-group">
                <label for="name" id="sku">Desc Clase de Factura</label>
            ...
            if (isset($_POST['submit'])) {
                ...
                try {
                    ...
                    $cproducto = (
                        "SELECT * from clfactura
                             where descripcion like $csku"
                    );
                    $contador = (
                        "SELECT count(clfact) as numero from clfactura
                            where descripcion like $csku"
                    );
