...
<head>
    ...
    <link rel="stylesheet" href="/css/consulta_cl_doc_cartera_uno.css">
...
<body>
    <header>
        <h1> Busqueda Clase Documento de Cartera Individual </h1>
    </header>
    <nav class="menu">
    ...
    <main>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            <div class="form-group">
                <label for="name" id="sku">Clase de Documento</label>
