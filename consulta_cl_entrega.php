...
<head>
    ...
    <link rel="stylesheet" href="/css/consulta_cl_entrega.css">
    <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <title>Clase de Entrega</title>
</head>

<body>
    <header>
        <h1> Consulta Clase de Entrega Individual </h1>
    </header>
    <nav class="menu">
    ...
    <main>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            <div class="form-group">
                <label for="name" id="sku">Clase de Entrega</label>
            ...
            if (isset($_POST['submit'])) {
                ...
                try {
                    ...
                    $cproducto = (
                        "SELECT * from clentrega
                             where clent like $csku"
                    );
                    // $contador = (
                    ...
                    echo "
                            ...
                            <thead class = 'thead-light'>
                                <tr>
                                    <th> Clase de Entrega </th>
                                    <th> Denominacion Clase de Entrega </th>
                                </tr>
                            </thead>";
